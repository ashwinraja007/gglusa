          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                ...
                >
                  To complement our supply chain solutions, we also build and manage customized e-commerce sites for our customers, offering a comprehensive range of features and services to facilitate their online business operations.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <AspectRatio ratio={16 / 9}>
                    <img
                      ...
                      src="/lovable-uploads/acbc23f0-2458-4e3d-9222-c80a8ea8ce46.png"
                    />
                  </AspectRatio>
                </motion.div>
              </div>
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto mb-12 text-center">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-3 mb-8 text-justify text-lg leading-relaxed">
                <li>Individualized Product Presentation</li>
                <li>Pricing Modules</li>
                <li>Customized Sales Management Process</li>
                <li>Integration with Warehouse, Transport, Freight Management & Finance Modules</li>
                <li>Payment Gateway Management Systems</li>
                <li>Dashboard with MIS</li>
              </ul>

              <p className="text-gray-700 text-justify font-normal text-lg leading-relaxed">
                By leveraging our e-commerce management system, businesses can enhance their online presence, streamline their e-commerce operations, and provide a seamless shopping experience for their customers. We strive to deliver customized solutions that meet the unique needs of each customer, enabling them to succeed in the competitive e-commerce landscape.
              </p>
            </div>
